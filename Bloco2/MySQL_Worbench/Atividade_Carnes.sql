...
values
("Picanha", 100.300, 58.00, 1),
("Peito de Frango", 80.730, 25.00, 3),
("Contra File", 250.480, 40.00, 1),
("Costela Suina", 200.620, 58.00, 2),
("Paleta", 200.620, 48.00, 5),
("Salmao", 100.620, 58.00, 4);
